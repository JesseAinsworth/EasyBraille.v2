...
// Create a memoized form section component
...
export default function SettingsPage() {
  ...
  const handleAlternativeImageSave = useCallback(async () => {
    if (!selectedFile) return
  ...
  const handleResetDb = useCallback(async () => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage({
          text: "Esquema de base de datos actualizado. Intenta subir la imagen nuevamente.",
          type: "success",
        })
      } else {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <FormSection title="Imagen de perfil">
      ...
      <FormSection title="Recuperar contraseña">
