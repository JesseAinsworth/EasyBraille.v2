    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-md overflow-hidden rounded-3xl shadow-xl">
        ...
        <div className="relative bg-gradient-to-br from-skyblue to-blue-300 p-8 text-white">
          ...
          <h1 className="text-3xl font-bold text-center mb-2">¡Comienza ahora!</h1>
          <p className="text-center text-blue-50 mb-8">Ingresa tus datos para crear una cuenta</p>

          {/* Botón de inicio de sesión en la parte inferior */}
          <div className="mt-12 text-center">
            <p className="text-blue-50 mb-2">¿Ya tienes una cuenta?</p>
            <Link
              href="/login"
